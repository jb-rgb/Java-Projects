...
public class Alumno {
    ...
    public void list(JTable tabla_alumnos)
    {
       ...
       public void seleccionar_usuario(JTable tabla_alumnos,JTextField jTextField1_id, JTextField jTextField1_nombre, JTextField jTextField1_matricula, JTextField jTextField1_Faltas, JTextField jTextField1_beca)
    {
        try{
    ...
    public void clear(JTable tabla_alumnos,JTextField jTextField1_id, JTextField jTextField1_nombre, JTextField jTextField1_matricula, JTextField jTextField1_Faltas, JTextField jTextField1_beca)
    {
...
public void insertar_alumno(JTextField jTextField1_nombre, JTextField jTextField1_matricula, int comboBox) {
    ...
    try {
        ...
        public void modificar_alumno(JTextField jTextField1_id, JTextField jTextField1_nombre, JTextField jTextField1_matricula, JTextField jTextField1_Faltas, JTextField jTextField1_beca)
    {
                /*private int id_alumno;  //Id del alumno por lo general se genera de forma automatica
                private String nombre_alumno;
                private String matricula;   //matricula del alumno 
            ...
            String consulta="UPDATE alumnos SET nombre_alumno=?, matricula=?, faltas=?,id_beca=? WHERE alumnos.id_alumno=?; " ; //donde va a estar guardada la consulta 
             try{
                 CallableStatement cs = objetoConexion.establecerConexion().prepareCall(consulta);
